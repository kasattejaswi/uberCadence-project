module github.com/kasattejaswi/uberCadence-project
...
require (
	...
	github.com/uber/cadence-idl v0.0.0-20211201154221-62425355ab97 // indirect
	...
	go.uber.org/yarpc v1.59.0 // indirect
